...
class BXBLEXTENSIONS_API UBxBLibrary : public UBlueprintFunctionLibrary {
	...
	static bool LoadLevelInstance(UObject* WorldContextObject, FString MapFolderOffOfContent, FString LevelName, int32 InstanceNumber, FVector Location, FRotator Rotation);
};